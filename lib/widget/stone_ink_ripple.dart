...
const Duration _kUnconfirmedRippleDuration = const Duration(milliseconds: 225);
...
// The fade out begins 375ms after the _fadeOutController starts. See confirm().
...
/// is used when the [Theme]'s [ThemeData.splashFactory] is [StoneInkRipple.splashFactory].
///
/// See also:
///
...
///    [Material].
class StoneInkRipple extends InteractiveInkFeature {
